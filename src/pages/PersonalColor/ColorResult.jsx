...
const toneDescriptions = {
  ...
  "Warm Spring": {
  title: "부드럽고 따뜻한 생기톤 Warm Spring",
  desc: [
    "따뜻한 옐로우 기반 컬러가 피부 톤을 가장 건강하고 화사하게 보이게 합니다.",
    "부드럽고 밝은 파스텔톤이 자연스럽게 어울리며 얼굴에 생기를 더해줍니다.",
    "채도가 너무 높은 색보다 따뜻하고 은은한 색상이 더 조화를 이룹니다."
  ],
  style: [
    "피치, 코랄, 따뜻한 베이지, 라이트 올리브, 샴페인 골드 계열 추천",
    "아이 메이크업은 소프트 브라운·골드·코랄 음영이 잘 어울립니다.",
    "상의는 아이보리, 크림베이지, 라이트 코랄, 따뜻한 파스텔톤 추천"
  ]
},
...
function CelebritySection({ season }) {
  ...
  const { female, male } = list;

  return (
    <div style={{ marginTop: 40 }}>
      {/* 여자 연예인 */}
      <h3 style={{ marginBottom: 16, fontSize: 22 }}>비슷한 톤의 여자 연예인</h3>
      <div
        style={{
          display: "flex",
          gap: 20,
      ...
      {/* 남자 연예인 */}
      <h3 style={{ marginTop: 30, marginBottom: 16, fontSize: 22 }}>
        비슷한 톤의 남자 연예인
      </h3>
      <div
        style={{
